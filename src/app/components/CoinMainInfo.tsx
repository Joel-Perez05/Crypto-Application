...
const CoinMainInfo: React.FC<CoinMainInfoTypes> = (props) => {
  ...
  return (
    <div className="h-full w-305">
      <div
        className={`dark:text-white dark:bg-[#1E1932] text-black bg-white w-full h-265 rounded-xl flex items-center justify-center flex-col`}
      >
        <div
          className={`h-16 w-16 mb-8 rounded dark:bg-[#2C2C4A] bg-[#f2f2fd] flex items-center justify-center`}
        >
      ...
      <div
        className={`dark:text-white dark:bg-[#1E1932] text-black bg-white w-full h-52 rounded-xl flex justify-center items-center mt-4 max-sm:mb-4`}
      >
